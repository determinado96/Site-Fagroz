  ...
  <div class="archive-agronomy-highlights__inner container">
    <div class="archive-agronomy-highlights__header">
      ...
      <div class="archive-agronomy-highlights__controls">
        ...
        <form id="archive-agronomy-highlights-form" class="archive-agronomy-highlights__search" role="search" method="get" action="<?php echo esc_url(get_post_type_archive_link('agronomy-highlight')); ?>">
