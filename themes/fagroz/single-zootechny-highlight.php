...
/**
 * Template singular para os destaques de zootecnia.
 */
        ...
        <div class="metabox metabox--position-up metabox--with-home-link">
          <p>
            ...
            <span class="metabox__main">
              <?php
              // Link to the CPT archive for 'zootechny-highlight'
              $archive_link = get_post_type_archive_link('zootechny-highlight');
              $archive_title = '';
              $pt_obj = get_post_type_object('zootechny-highlight');
